      ...
      <div className="container py-8 sm:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm opacity-80 mb-4">Baked with love, served with joy.</p>
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="opacity-70 hover:opacity-100 transition-opacity">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm opacity-80">
              ...
              <li><Link to="/custom-cake" className="hover:opacity-100 transition-opacity">Custom Cakes & Hampers</Link></li>
